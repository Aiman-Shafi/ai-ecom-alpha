          ...
          <div className="hero-visual">
            ...
            <div className="hero-video-player">
              <div className="screen-bar">
                ...
                <div className="screen-url">app.genieos.co — Watch Demo</div>
              </div>
              <div className="hero-video-frame">
                <iframe
                  src="https://www.youtube.com/embed/JxJIoj4pSaE?rel=0&showinfo=0&modestbranding=1&color=white&iv_load_policy=3"
                  title="Genie OS — Product Demo"
